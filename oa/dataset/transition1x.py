...
from oa.dataset.base_dataset import BaseDataset, ATOM_MAPPING
...
class ProcessedTS1x(BaseDataset):
    def __init__(
        ...
        **kwargs,
        ...
        single_frag_inds = sorted(set(single_frag_inds).intersection(set(use_inds))) # to make sure the order is the same as original data
        # print(len(single_frag_inds))
